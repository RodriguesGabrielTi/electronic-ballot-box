 ...
 * @author santi
 */
public class ViewUrnaSecretario extends javax.swing.JFrame {
    ...
    public void check(){
        ...
        for (Chapa c : pdao.readTela()) {
            if(nu==c.getNumero() && (c.getFuncao().equals("Secretário"))){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewUrnaSecretario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
